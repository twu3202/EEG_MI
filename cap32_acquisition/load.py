...
The label track is the software `marker` (small MI codes 1–5, see mi_events) when
...
from mi_events import CODE_TO_LABEL                      # noqa: E402
...
def read_recording(path):
    ...
    if path.endswith(".fif"):
        ...
        try:
            ...
            from mi_events import MI_TASK_CODES
