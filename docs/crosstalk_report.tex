...
\usepackage{graphicx,booktabs,amsmath,siunitx,xcolor,caption}
...
\definecolor{good}{RGB}{46,158,91}
\definecolor{bad}{RGB}{192,57,43}
\definecolor{warn}{RGB}{197,138,0}
...
\texttt{INxP}/\texttt{INxN} pin: \emph{``Connect unused analog inputs directly to AVDD.''}
...
\begin{tabular}{ll}
\toprule
\texttt{recordings/calibrator/cal\_7hz\_180s.npz} & \SI{179}{\second}, the record analysed here \\
\texttt{recordings/calibrator/cal\_7hz\_xt7hz\_60s.npz} & \SI{59}{\second} \\
\texttt{recordings/calibrator/cal\_7hz\_probe11s.npz} & \SI{11}{\second} \\
\texttt{results/crosstalk7.json} & every number in this report \\
\bottomrule
\end{tabular}
\end{center}
